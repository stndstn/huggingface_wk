...
namespace ScanID
{
    public class ScanIDOCR
    {
        ...
        string m_country = "";
        string[] m_docTypes = { };
        Dictionary<string, MatchTemplateIDCard> m_matchTemplates = null;
        protected ScanIDOCR(string country, Dictionary<string, MatchTemplateIDCard> matchTemplates)
        {
        ...
        static Dictionary<string, MatchTemplateIDCard?> s_dictMatchTemplate = new Dictionary<string, MatchTemplateIDCard?>();
        static MatchTemplateIDCard? GetMatchTemplate(string strPathTmplDir, string name)
        {
        ...
        public static ScanIDOCR Create(string strPathTmplDir, string country)
        {
            switch (country.ToUpper())
            {
                case "MY":
                    {
                        MatchTemplateIDCard? matchTemplateMyKad = ScanIDOCR.GetMatchTemplate(strPathTmplDir, "mykad_fr");
                        MatchTemplateIDCard? matchTemplateMYDL = ScanIDOCR.GetMatchTemplate(strPathTmplDir, "mydl_fr");
                        Dictionary<string, MatchTemplateIDCard?> matchTemplatesMY = new Dictionary<string, MatchTemplateIDCard?>(){
                ...
                case "PH":
                    {
                        MatchTemplateIDCard? matchTemplatePHDL = ScanIDOCR.GetMatchTemplate(strPathTmplDir, "phdl_fr");
                        MatchTemplateIDCard? matchTemplatePHUMID = ScanIDOCR.GetMatchTemplate(strPathTmplDir, "phumid_fr");
                        MatchTemplateIDCard? matchTemplatePHNI = ScanIDOCR.GetMatchTemplate(strPathTmplDir, "phni_fr");
                        Dictionary<string, MatchTemplateIDCard?> matchTemplatesPH = new Dictionary<string, MatchTemplateIDCard?>(){
                    ...
                    break;
                default:
                    return new ScanIDOCR(country.ToUpper(), new Dictionary<string, MatchTemplateIDCard?>());
                    break;
            }
        }


        public MatchTemplateIDCard GetMatchTemplate(string docType)
        {
        ...
        public ScanIDResult ScanIDB64(string baseAddrUrl, string imageSrcB64, string imageSrcB64Back = "", string docType = "")
        {
            ...
            using (SKImage bmpImage = SKImage.FromEncodedData(skDataImageSrc))
            {
                ...
                try
                {
                    ...
                    bFaceFound = LibImport.DlibDetectFace(dataImageSrc, dataImageSrc.Length, rectFace);
                    if(bFaceFound == 1)
                    {
                        valLeft = rectFace[0];
                        valTop = rectFace[1];
                        valRight = rectFace[2];
                        valBottom = rectFace[3];
                    }
                ...
                if (image != null)
                {
                    ...
                    if (bFaceFound == 1)
                    {
                        ...
                        int width = valRight - valLeft;
                        int height = valBottom - valTop;
                        int leftFaceArea = valLeft - width / 2;
                        if (leftFaceArea < 0) leftFaceArea = 0;
                        int topFaceArea = valTop - height / 2;
                        if (topFaceArea < 0) topFaceArea = 0;
                        int rightFaceArea = valRight + width / 2;
                        if (rightFaceArea > image.Width) rightFaceArea = image.Width;
                        int bottomFaceArea = valBottom + height / 2;
                    ...
                    if (!string.IsNullOrEmpty(docType))
                    {
                        ...
                        {
                            MatchTemplateIDCard matchTemplate = m_matchTemplates[docType];
        ...
        public ScanMyKadResult ScanMyKad(Line[] linesMergedAll, SKImage imageSrc, MatchTemplateIDCard? matchTemplateMyKad, LabelInfo[] labelsFound, Line[] linesMergedNotLabel)
        {
        ...
        //public static ScanMYDLResult ScanMYDLB64(string baseAddrUrl, string imageSrcB64, MatchTemplateIDCard? matchTemplateMYDL)
        public ScanMYDLResult ScanMYDL(Line[] linesMergedAll, SKImage imageSrc, 
            MatchTemplateIDCard? matchTemplateMYDL, LabelInfo[] labelsFound, Line[] linesMergedNotLabel)
        {
            DateTime dtStart2 = DateTime.Now;
        ...
        */
        ...
        public ScanPHUMIDResult ScanPHUMID(Line[] linesMergedAll, SKImage imageSrc, SKRectI? rcFace, MatchTemplateIDCard? matchTemplatePHUMID, LabelInfo[] labelsFound, Line[] linesMergedNotLabel)
        {
        ...
        public ScanPHUMIDResult ScanPHUMID1(Line[] linesMergedAll, SKImage imageSrc, SKRectI? rcFace, MatchTemplateIDCard? matchTemplatePHUMID, LabelInfo[] labelsFound, Line[] linesMergedNotLabel)
        {
            List<LabeledObject> labeledObjects = new List<LabeledObject>();
        ...
        public ScanPHUMIDResult ScanPHUMID2(Line[] linesMergedAll, SKImage imageSrc, SKRectI? rcFace, MatchTemplateIDCard? matchTemplatePHUMID, LabelInfo[] labelsFound, Line[] linesMergedNotLabel)
        {
            List<LabeledObject> labeledObjects = new List<LabeledObject>();
        ...
        /*
        public static ScanPHDLResult ScanPHDL(string baseAddrUrl, string imageFileName, MatchTemplateIDCard? matchTemplatePHDL)
        {
        ...
        //public static ScanPHDLResult ScanPHDLB64(string baseAddrUrl, string imageSrcB64, MatchTemplateIDCard? matchTemplatePHDL)
        ...
        /*
        public ScanPHNIResult ScanPHNI(string baseAddrUrl, string imageFileName, string backImageFileName, MatchTemplateIDCard? matchTemplatePHNI)
        {
        ...
        */
        ...
        //public ScanPHNIResult ScanPHNIB64(string baseAddrUrl, string imageSrcB64, string imageBackSrcB64, MatchTemplateIDCard? matchTemplatePHNI)
        public ScanPHNIResult ScanPHNI(Line[] linesMergedAll, SKImage imageSrc, 
            MatchTemplateIDCard? matchTemplatePHNI, LabelInfo[] labelsFound, Line[] linesMergedNotLabel,
        ...
        public ScanMYDLResult ExtractFieldsFromReadResultOfMYDL(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKImage imageSrc, MatchTemplateIDCard? matchTemplateMYDL)
        {
        ...
        bool DoMatchTemplate(MatchTemplateIDCard? matchTemplate, SKImage imageSrc, double topEdgeYOfIDImageInPixel, double leftEdgeXOfIDImageInPixel, double ppi,
...
#if true
        ScanMyKadResult ExtractFieldsFromReadResultOfMyKad(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKImage imageSrc, MatchTemplateIDCard? matchTemplateMyKad)
        {
            const double ACCEPTABLE_DIFF_IN_LINE = 0.1f;
            List<Line> lsLineMergedNotLabel = new List<Line>();
            lsLineMergedNotLabel.AddRange(linesMergedNotLabel); 
...
#else
        public static ScanMyKadResult ExtractFieldsFromReadResultOfMyKad(IList<Line> mergedLines, SKImage imageSrc, MatchTemplateIDCard? matchTemplateMyKad)
        {
            const double ACCEPTABLE_DIFF_IN_LINE = 0.1f;
...
MatchTemplate key: MyKad_670_MyKad_Gray MatchResult: 0.9301272630691528 x: 376 y: 9 w: 61 h: 39
...
#if true
        //public static ScanPHUMIDResult ExtractFieldsFromReadResultOfPHUMID(IList<Line> linesAll, List<LabeledObject> labeledObjects, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHUMID)
        ScanPHUMIDResult ExtractFieldsFromReadResultOfPHUMID(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKRectI? rcFace, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHUMID)
        {
        ...
        ScanPHUMIDResult ExtractFieldsFromReadResultOfPHUMID1(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKRectI? rcFace, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHUMID)
        {
            // For UMID with face picture located in the right side
            const double CENTER_Y_INCH_CRN_FACE_R = 0.62f;
            const double CENTER_Y_INCH_SURNAME_FACE_R = 0.74f;
        ...
        ScanPHUMIDResult ExtractFieldsFromReadResultOfPHUMID2(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKRectI? rcFace, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHUMID)
        {
            // For UMID with face picture located in the right side
            const double CENTER_Y_INCH_CRN_FACE_R = 0.62f;
            const double CENTER_Y_INCH_SURNAME_FACE_R = 0.74f;
...
#endif
#if true
        ScanPHNIResult ExtractFieldsFromReadResultOfPHNI(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHNI)
        {
            const double ACCEPTABLE_DIFF_IN_LINE = 0.1f;
...
#else
        ScanPHNIResult ExtractFieldsFromReadResultOfPHNI(IList<Line> linesAll, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHNI)
        {
            const double ACCEPTABLE_DIFF_IN_LINE = 0.1f;
            ScanPHNIResult result = new ScanPHNIResult();
...
#if true
        public ScanPHDLResult ExtractFieldsFromReadResultOfPHDL(LabelInfo[] labelsFound, Line[] linesMergedNotLabel, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHDL)
        {
            const double ACCEPTABLE_DIFF_IN_LINE = 0.1f;
            const double labelHeightFilterInInch = 0.07f;
...
#else
        public static ScanPHDLResult ExtractFieldsFromReadResultOfPHDL(IList<Line> linesAll, SKImage imageSrc, MatchTemplateIDCard? matchTemplatePHDL)
        {
            //char[] SEPARATOR_NAME = new char[] { ',', '.', ' ' };
...
#endif
        public static MatchTemplateIDCard? LoadMatchTemplate(string strPathTmplDir, string name)
        {
            ...
            else
            {
                ...
                {
                    MatchTemplateIDCard matchTemplate = new MatchTemplateIDCard(tmpl_name);
