...
#include <streambuf>
#include "DlibDn47.h"
#include "..\DlibWrapper\DlibWrapper.h"
...
bool DlibDetectFace(unsigned char* pImageData, int nSize, int pts[8])
{
...
{
	//static
	bool DlibWrapper::DetectFace(array<System::Byte>^ imageSrc, System::Int32^% left, System::Int32^% top, System::Int32^% right, System::Int32^% bottom)
	{
		bool bRet = false;
		pin_ptr<System::Byte> p = &imageSrc[0];   // entire array is now pinned
	...
	System::String^ DlibWrapper::Hello(System::String^ value) {
		System::String^ ret = "hello ";
		ret += value;
		return ret;
	}
}
