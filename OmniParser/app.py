...
omniparser = ocromniparser.Omniparser(ocromniparser.config)
    ...
    if request.method == 'POST':        
        if request.is_json:
            ...
            if b64 != None:
                ...
                return omniparser.parseImage(image)
    ...
    if request.method == 'POST':     
        if request.is_json:
            ...
            if b64 != None:
                ...
                result = omniparser.parseImage(image)
                ret = {'<OCR_WITH_REGION>': result}
                return ret
